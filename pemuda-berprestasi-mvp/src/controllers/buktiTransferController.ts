...
export const BuktiTransferController = {
  ...
  upload: async (req: Request, res: Response) => {
    try {
      ...
      // Save to database
      const buktiTransfer = await prisma.buktiTransfer.create({
        data: {
  ...
  getAll: async (req: Request, res: Response) => {
    try {
      const buktiTransfers = await prisma.buktiTransfer.findMany({
  ...
  delete: async (req: Request, res: Response) => {
    try {
      ...
      const buktiTransfer = await prisma.buktiTransfer.findUnique({
      ...
      await prisma.buktiTransfer.delete({
        where: { id_bukti_transfer: parseInt(id) }
      })
