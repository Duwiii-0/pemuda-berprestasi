    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
            <div className="bg-white rounded-xl p-6 w-[90%] max-w-sm text-center shadow-lg">
                <div className="w-20 h-20 mx-auto mb-4 flex items-center justify-center rounded-full bg-gray-300 text-red">
                ...
                <div className="mt-6 flex justify-center gap-4">
                    ...
                    <button
                        onClick={onConfirm}
                        className="px-8 py-2 bg-red text-white rounded-md hover:bg-red-700 transition cursor-pointer">
                    OK
                    </button>
                </div>
            </div>
