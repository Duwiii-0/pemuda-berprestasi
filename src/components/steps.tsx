...
const Steps: React.FC<StepsProps> = ({ number, title, desc }) => {
  return (
    <div className="w-full h-60 flex gap-8 justify-center group">
      ...
      <div className="flex flex-col gap-2 sm:gap-4 bg-white shadow-2xl rounded-xl w-3/4 px-8 py-4 sm:py-8 border-2 border-yellow group-hover:scale-102 transition-all duration-300">
