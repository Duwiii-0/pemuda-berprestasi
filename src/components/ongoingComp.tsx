...
const OngoingComp = () => {
     ...
     return (
        <div className="relative bg-white pt-20 md:pt-0 md:h-[70vh] 2xl:h-[80vh] w-full flex flex-col justify-start items-center md:items-start gap-10 lg:gap-16 xl:gap-20">
