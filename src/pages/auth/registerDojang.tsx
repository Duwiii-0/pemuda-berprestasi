  ...
  <div className="h-screen w-full flex items-center justify-center bg-cover bg-center"
      ...
      <div className="px-10 sm:px-25 bg-gradient-to-b from-white/90 to-white/80 h-screen md:h-[80vh] w-full md:w-[72vw] lg:w-[56vw] xl:w-[35vw] rounded-xl flex flex-col justify-start items-center gap-8 py-10 overflow-y-scroll font-inter">
        <div className="flex flex-col gap-2 justify-center items-center">
            <img src="src/assets/logo/taekwondo.png" alt="taekwondo logo" className="sm:h-50 sm:w-50 h-30 w-30"/>
            <label className="font-bebas text-6xl text-center text-red">registrasi Dojang</label>
        </div>
    ...
    <div className="mt-2 w-full flex flex-col gap-2">
      ...
      <Link to="/register" className="underline text-red hover:text-red-600">
        Register here
      </Link>
    </div>
    </div>
