        ...
        <div className="h-screen w-full flex items-center justify-center bg-cover bg-center"
            ...
            <div className="px-20 bg-white h-screen md:h-[50vh] w-full md:w-[72vw] lg:w-[56vw] xl:w-[42vw] rounded-xl flex flex-col justify-center items-center gap-8 border-3 border-yellow py-10 font-inter">
                ...
                <div className="w-full flex flex-col gap-2">
                    <GeneralButton label="Login" type="link" className="w-full bg-red border-2 border-red h-12 text-white round-lg font-semibold"/>
                    <Link to='/' className="pl-1 underline hover:text-red">Back to home page</Link>
                </div>
            </div>
        </div>
    )
