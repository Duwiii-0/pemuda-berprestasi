...
const AllPeserta: React.FC = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5FBEF' }}>
      {/* CONTAINER - Padding yang sama dengan AllAtlets untuk sidebar layout */}
      <div className="px-4 py-6 sm:px-6 lg:px-8 xl:px-12 2xl:px-24 max-w-7xl mx-auto">
        
        {/* HEADER - Diperbaiki untuk konsisten dengan AllAtlets */}
        ...
        {/* FILTER + SEARCH - Layout responsif yang sama dengan AllAtlets */}
        <div className="rounded-xl shadow-sm border p-4 sm:p-6 mb-6" style={{ backgroundColor: '#F5FBEF', borderColor: '#990D35' }}>
          <div className="space-y-4">
            ...
            {/* Filter dalam grid responsif - Disesuaikan untuk mobile */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-2xl border shadow-sm focus:ring-2 focus:border-transparent text-sm transition-colors"
                  style={{ 
                    borderColor: '#990D35', 
                    backgroundColor: '#F5FBEF',
                    color: '#050505'
        ...
        {/* CONTENT */}
        <>
          {/* Mobile Cards View - Design konsisten dengan AllAtlets */}
          ...
          {/* Desktop Table View - Layout konsisten dengan AllAtlets */}
                  ...
                  <tbody className="divide-y" style={{ borderColor: '#990D35' }}>
                    {currentPesertas.map((peserta: any) => {
                      ...
                      return (
                        ...
                        >
                          <td className="py-4 px-4 font-medium text-sm" style={{ color: '#050505' }}>
                          ...
                          <td className="py-4 px-4 text-sm" style={{ color: '#050505', opacity: 0.7 }}>{kelasBerat}</td>
                          {/* Kelas Poomsae */}
                          <td className="py-4 px-4 text-sm" style={{ color: '#050505', opacity: 0.7 }}>
