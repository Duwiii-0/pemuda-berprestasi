...
const AdminKompetisiLayout: React.FC = () => {
  ...
  const pageDescription = currentPage?.description || 'Kelola kompetisi dengan mudah';
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5FBEF' }}>
        ...
        <div className="h-full shadow-lg border-r" style={{ backgroundColor: '#F5FBEF', borderColor: '#990D35' }}>
          ...
          <div className="p-6 border-b" style={{ borderColor: '#990D35' }}>
            <div className="flex items-center gap-3">
              <div className="p-3 rounded-xl shadow-sm" style={{ backgroundColor: '#990D35' }}>
          ...
          <div className="p-6 border-b" style={{ borderColor: '#990D35' }}>
            <div className="flex items-center gap-3">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center font-bold text-xl shadow-sm" style={{ backgroundColor: '#F5B700', color: '#050505' }}>
                {displayName.charAt(0).toUpperCase()}
              </div>
              <div className="flex-1">
                <p className="font-semibold text-base truncate" style={{ color: '#050505' }}>
                  {displayName}
                </p>
          ...
          <nav className="p-6 space-y-2">
            <h3 className="text-sm font-semibold mb-4" style={{ color: '#050505', opacity: 0.7 }}>
              NAVIGATION
            </h3>
            {menuItems.map((item) => (
              <button
      ...
      {/* Mobile Header */}
      <div className="lg:hidden border-b px-4 py-3 shadow-sm" style={{ backgroundColor: '#F5FBEF', borderColor: '#990D35' }}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm" style={{ backgroundColor: '#F5B700', color: '#050505' }}>
              {displayName.charAt(0).toUpperCase()}
            </div>
          </div>
        </div>
      ...
      {sidebarOpen && (
        <>
          ...
          />
          <aside className="fixed inset-y-0 left-0 z-50 w-80 shadow-xl lg:hidden overflow-y-auto" style={{ backgroundColor: '#F5FBEF' }}>
            <div className="p-6 border-b flex items-center justify-between" style={{ borderColor: '#990D35' }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bebas" style={{ color: '#050505' }}>
                    ADMIN KOMPETISI
                  </h1>
                </div>
              </div>
            ...
            <div className="p-6 border-b" style={{ borderColor: '#990D35' }}>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center font-bold" style={{ backgroundColor: '#F5B700', color: '#050505' }}>
                  {displayName.charAt(0).toUpperCase()}
                </div>
                <div>
      ...
      <main className="lg:ml-80">
        ...
        <div className="bg-white border-b px-6 py-4" style={{ borderColor: '#990D35' }}>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-sm" style={{ color: '#050505', opacity: 0.6 }}>
